...
public class MainWIndow extends JFrame {
	...
	public String chatKey;//用来标识具体的对话框，以方便显示
	...
	public MainWIndow() {
		...
		JButton button_2 = new JButton("群聊");
		button_2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				
				ChatManager.getCM().sendCommand("command;groupTalk;1;2;3;");
		...
		button_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				ChatManager.getCM().sendCommand("command;friendTalk;1;2;");
				...
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addComponent(button))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(button_2, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
